...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `company_tbl` WHERE `company_tbl`.`id` = $sno";
...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `company_tbl` SET `cname` = '$cname' , `address` = '$address' WHERE `company_tbl`.`id` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `company_tbl` (`id`, `cname`, `address`) VALUES (NUll, '$cname', '$address')";
  $result = mysqli_query($conn, $sql);
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/web-assignment/dashboard.php" method="POST">
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/web-assignment/dashboard.php?delete=${sno}`;
